...
public class UserService {
    ...
    public Iterable<UserDto> getAllUsers(String sortBy) {
        ...
        var dtoList = new java.util.ArrayList<UserDto>();
        users.forEach(u -> dtoList.add(userMapper.toDto(u)));
        return dtoList;

        // JpaRepository required (UserRepository has been updated to a CrudRepository)
